...
/* --> PITA_standby */
extern xdc_Void PITA_standby(xdc_Void);
...
/* --> navigate_snake */
extern xdc_Void navigate_snake(xdc_UArg,xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/TI_RTOS/Workspace/PITA/Debug/configPkg/package/cfg/PITA_pem4f");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[3] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)PITA_standby)),  /* [0] */
...
ti_sysbios_knl_Swi_Object__ ti_sysbios_knl_Swi_Object__table__V[2] = {
    {/* instance#0 */
        ...
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)navigate_snake)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
...
#endif
#endif
const ti_sysbios_knl_Swi_Handle Field_Navigation = (ti_sysbios_knl_Swi_Handle)((ti_sysbios_knl_Swi_Handle)&ti_sysbios_knl_Swi_Object__table__V[0]);
