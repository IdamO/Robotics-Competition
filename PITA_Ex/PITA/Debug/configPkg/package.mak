...
.dlls,em4f .dlls: PITA.pem4f

-include package/cfg/PITA_pem4f.mak
-include package/cfg/PITA_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/PITA_pem4f.dep
endif
PITA.pem4f: package/cfg/PITA_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
PITA.pem4f package/cfg/PITA_pem4f.c: .libraries,em4f
endif

package/cfg/PITA_pem4f.c package/cfg/PITA_pem4f.h package/cfg/PITA_pem4f.xdl: override _PROG_NAME := PITA.xem4f
package/cfg/PITA_pem4f.c: package/cfg/PITA_pem4f.cfg
package/cfg/PITA_pem4f.xdc.inc: package/cfg/PITA_pem4f.xdl
package/cfg/PITA_pem4f.xdl package/cfg/PITA_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/PITA_pem4f.cfg
	-$(RM) package/cfg/PITA_pem4f.dep
	-$(RM) package/cfg/PITA_pem4f.c
	-$(RM) package/cfg/PITA_pem4f.xdc.inc

clean,em4f::
	-$(RM) PITA.pem4f
.executables,em4f .executables: PITA.xem4f

PITA.xem4f: |PITA.pem4f

-include package/cfg/PITA.xem4f.mak
PITA.xem4f: package/cfg/PITA_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/PITA_pem4f.oem4f   package/cfg/PITA_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
PITA.xem4f: export C_DIR=
PITA.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
PITA.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

PITA.test test,em4f test: PITA.xem4f.test

PITA.xem4f.test:: PITA.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 PITA.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.PITA.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,PITA.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
PITA_pem4f.oem4f,copy : package/cfg/PITA_pem4f.oem4f
PITA_pem4f.sem4f,copy : package/cfg/PITA_pem4f.sem4f
